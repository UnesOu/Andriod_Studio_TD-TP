...
public class PopularMovies extends AppCompatActivity implements MovieAdapter.OnMovieListener {
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                ...
                switch (id) {
                    ...
                    case R.id.navigation_new_movies:
                        Intent i = new Intent(PopularMovies.this, NewMovies.class);
                        startActivity(i);
                        finish();
                        return true;
                }
    ...
    private void GetPopularMovies() {
        ...
        Call<MovieResponse> call = movieService.listPopularMovies("dbd6335317217b32317f8cb921c632d5");
